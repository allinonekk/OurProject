...
/*****************************************************************************************************
* Description : This file represents a generic Validation implementation.
*
*-----------------------------------------------------------------------------------------------------
*	                                    File History
*-----------------------------------------------------------------------------------------------------
...
*****************************************************************************************************/
// <summary>
// File: DesignByContract.cs
// Description: Class <see cref="Check" />implements generic validations.
// THis also has some custom Exceptions.
// </summary>
// <copyright file= "DesignByContract.cs" company="AllInOne Pte Ltd">
...
namespace AllInOne.Common.DataAccess.Utilities
{
    ...
    public sealed class Check
    {
        ...
        /// Precondition check - should run regardless of preprocessor directives.
        /// </summary>
        public static void RequireWithNullException(bool assertion, string message)
        {
            //if (UseExceptions)
            //{
